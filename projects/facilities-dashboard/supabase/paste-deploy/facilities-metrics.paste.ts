// ============================================================================
// facilities-metrics  —  SINGLE-FILE build for the Supabase DASHBOARD editor.
// Paste this ENTIRE file into the web editor for the 'facilities-metrics'
// function, then Deploy with **Verify JWT = OFF** (anonymous variant).
// It is functions/facilities-metrics/index.ts with _shared/aggregate.ts inlined.
// (The canonical multi-file source lives in functions/ — this copy is only for
//  the no-CLI paste-deploy path.)
// ============================================================================
...
// ---------------------------------------------------------------------------
// HTTP handler (from functions/facilities-metrics/index.ts; import line removed)
// ---------------------------------------------------------------------------
