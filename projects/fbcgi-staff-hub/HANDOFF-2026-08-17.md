...
> Note (added when committing to this repo): this document contains interim dashboard
> passcodes (see §2E). The repo is private, and these are placeholder gates until SSO
> ships — but be aware they are recorded here.
